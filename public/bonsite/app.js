...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__navs_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__navs_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__navs_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_scrollmagic__ = __webpack_require__(1);
...
const TimelineMax = __webpack_require__(17);
...
$(document).ready(function () {
    ...
    tl
        ...
        .from(h3, 1, {autoAlpha: 0}, '+=0.01')
        .from(logo, 0.5, {opacity: 0, x: -200, ease: Power0.easeOut}, '-=0.25')
        .add(function () {
            __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].set(logo, {clearProps: "all"});
            __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].set(ticket, {clearProps: "all"});
        });
    //animation on scroll//
    ...
    $('.section').each(function () {
        ...
        timeline
            ...
            .from(p, 0.25, {opacity: 0, y: 50, ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Power1"].easeOut})
            .from(bg, 0.5, {width: 0})
            .from(button, 0.5, {opacity: 0, x: -200})
            .add(function () {
                button.addClass('animated')
                __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].set(button, {clearProps: "all"});
                __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].set(bg, {clearProps: "all"});
            });
    ...
    function getDataFromRoom() {
        return __WEBPACK_IMPORTED_MODULE_5_axios___default.a.get('https://www.becentral.org/room.json')
    }
    ...
    link.forEach((element) => {
        element.addEventListener('click', () => {
            ...
            __WEBPACK_IMPORTED_MODULE_1_gsap__["TweenLite"].from($('.name'), 0.5, {x: -100, autoAlpha: 0})

            var rooms = new TimelineMax();
            rooms
                .fromTo($('.green_overlay'), 0.5, {width: 0}, {width: "100%", ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Power4"].easeInOut})
                .fromTo($('.green_overlay'), 0.5, {x: "0%"}, {x: "100%", ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Power4"].easeInOut})
                .add('controll')
                .from(roomImage, 0.25, {x: "-100%", ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Power4"].easeInOut}, "-=0.5")
                .fromTo($('.grey_overlay'), 0.5, {width: 0,}, {width: "100%", ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Power4"].easeInOut}, "-=0.5")
                .fromTo($('.grey_overlay'), 0.5, {x: "0%"}, {x: "100%", ease: __WEBPACK_IMPORTED_MODULE_1_gsap__["Power4"].easeInOut}, "-=0.5")
    ...
    $('#openMenu').click(function () {
        ...
        opening
            ...
            .staggerFrom($('.LinkBurger'), 0.15, {opacity:0,x: -290}, 0.1)
    });
    ...
    $('#ham').click(function () {
        ...
        tl
            ...
            .staggerFrom($('.LinkBurger'),0.15,{opacity:0,x:-100,yoyo:true,ease:Power2.easeInOut},0.1)
...
(function(name) {
	...
	if (typeof(module) !== "undefined" && module.exports) { //node
		__webpack_require__(18); //dependency
