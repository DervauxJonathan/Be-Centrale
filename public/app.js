...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scss_app_scss__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_scrollmagic__ = __webpack_require__(9);
...
$(document).ready(function() {
 ...
 .from(logo, 0.5, {opacity:0, x:-200,ease:Power0.easeOut},'-=0.25');        
      ...
      __WEBPACK_IMPORTED_MODULE_2_gsap__["TweenLite"].to(green, 1,{width:0})
      __WEBPACK_IMPORTED_MODULE_2_gsap__["TweenLite"].to(grey, 1.5,{width:0, delay:0.25});
      __WEBPACK_IMPORTED_MODULE_2_gsap__["TweenLite"].from(title, 0.5,{opacity:0, delay:.75, ease:Power0.easeInOut});
  tl
    ...
    __WEBPACK_IMPORTED_MODULE_2_gsap__["TweenLite"].from(bg,1,{width:0, delay:1})
    .addTo(controller);
    })
