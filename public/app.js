...
//animation on scroll//
    ...
    $('.section').each(function(){
        ...
        timeline
            ...
            .from(p, 0.25,{opacity:0, y:50,ease:__WEBPACK_IMPORTED_MODULE_2_gsap__["Power1"].easeOut})
    ...
    function getDataFromRoom() {
        return __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get('http://localhost:3000/room.json')
    }
    ...
    link.forEach((element) => {
        element.addEventListener('click', () => {
            ...
            __WEBPACK_IMPORTED_MODULE_2_gsap__["TweenLite"].from($('.paragraphe'),0.5,{width:0,ease:__WEBPACK_IMPORTED_MODULE_2_gsap__["Power1"].easeOut});
            __WEBPACK_IMPORTED_MODULE_2_gsap__["TweenLite"].from($('.name'),0.5,{x:-100,autoAlpha:0})
...
throw new Error("Module build failed: \n    @extend .section_title_style;\n           ^\n      \".join_us .section_title\" failed to @extend \".section_title_style\".\nThe selector \".section_title_style\" was not found.\nUse \"@extend .section_title_style !optional\" if the extend should be able to fail.\n      in /Users/delphine/Documents/GitHub/Be-Centrale/assets/scss/layout/_join_us.scss (line 16, column 13)");
